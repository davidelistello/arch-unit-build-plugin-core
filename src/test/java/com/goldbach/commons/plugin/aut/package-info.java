 ...
 * <p>
 * {@link com.goldbach.commons.plugin.aut.main} gets copied to {@code target/aut-target/classes} whereas
 * {@link ccom.goldbach.commons.plugin.aut.test} gets copied to {@code target/aut-target/test-classes}.
 * <p>
 * This allows the tests to run just against these set of classes and not against themselves, too.
 */
package com.goldbach.commons.plugin.aut;